				...
				<div class="row">
					...
					<form action="ourbusiness/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版2,5)图2:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版5)图3:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版5)图4:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版3)标题:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版3,7,8)内容1:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版3,7,8)内容2:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版3,7,8)内容3:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版7,8)服务标题1:</td>
								<td><input type="text" name="M7_TITLE1" id="M7_TITLE1" value="${pd.M7_TITLE1}" maxlength="10" placeholder="服务标题1" title="服务标题1" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版7,8)服务标题2:</td>
								<td><input type="text" name="M7_TITLE2" id="M7_TITLE2" value="${pd.M7_TITLE2}" maxlength="10" placeholder="服务标题2" title="服务标题2" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="text-align: right;padding-top: 13px;">(模版7,8)服务标题3:</td>
								<td><input type="text" name="M7_TITLE3" id="M7_TITLE3" value="${pd.M7_TITLE3}" maxlength="10" placeholder="服务标题3" title="服务标题3" style="width:98%;"/></td>
							</tr>
							<tr>
