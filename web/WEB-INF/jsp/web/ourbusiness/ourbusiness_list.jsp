							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<th class="center" style="width:130px;">介绍上</th>
											<td>${var.TITLE1}</td>
										</tr>
										<tr>
										...
										<tr>
											<th class="center">(模版3,7,8)内容1</th>
											<td>${var.M3_CONTENT1}</td>
										</tr>
										<tr>
											<th class="center">(模版3,7,8)内容2</th>
											<td>${var.M3_CONTENT2}</td>
										</tr>
										<tr>
											<th class="center">(模版3,7,8)内容3</th>
											<td>${var.M3_CONTENT3}</td>
										</tr>
										<tr>
											<th class="center">(模版7,8)服务标题1</th>
											<td>${var.M7_TITLE1}</td>
										</tr>
										<tr>
											<th class="center">(模版7,8)服务标题2</th>
											<td>${var.M7_TITLE2}</td>
										</tr>
										<tr>
											<th class="center">(模版7,8)服务标题3</th>
											<td>${var.M7_TITLE3}</td>
										</tr>
										<tr>
