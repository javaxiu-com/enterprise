				...
				<div class="row">
					...
					<form action="information/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">描述:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">logo:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">版权:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">技术支持:</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">备案:</td>
								<td><input type="text" name="BEIAN" id="BEIAN" value="${pd.BEIAN}" maxlength="15" placeholder="这里输入备案" title="备案" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="text-align: right;padding-top: 13px;">关于我们(图,模版7):</td>
								<td><input type="text" name="IMG1" id="IMG1" value="${pd.IMG1}" maxlength="100" placeholder="这里选择图片" title="logo" style="width:86%;" onmouseover="showTU('IMG1','yulantu2');" onmouseout="hideTU('yulantu2');"/>
								<div class="yulantu" id="yulantu2"></div>
									<a class="btn btn-xs btn-info" style="margin-top: -5px;" title="选择" onclick="xuanTp('IMG1');">选择 </a>
								</td>
							</tr>
							<tr>
								<td style="text-align: right;padding-top: 13px;">关于我们(上):</td>
							...
							<tr>
								<td style="text-align: right;padding-top: 13px;">关于我们(下):</td>
